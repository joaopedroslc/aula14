package com.example.arqdsis.ciclodevida.util;

/**
 * Created by arqdsis on 29/11/2017.
 */
...
public class Utils {
    ...
    private static com.example.arqdsis.ciclodevida.util.StatusTracker mStatusTracker = com.example.arqdsis.ciclodevida.util.StatusTracker.getInstance();
